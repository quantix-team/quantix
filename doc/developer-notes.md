...
Quantix Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Quantix Core, where everyone uses
...
pay attention to for reviewers of Quantix Core code.

General Quantix Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Quantix Core uses tinyformat, which is type safe. Leave them out to avoid confusion
