...
This mechanism has been integrated into Bitcore-Node-Quantix which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/quantixcoin/insight-api-quantix#web-socket-api](https://github.com/quantixcoin/insight-api-quantix#web-socket-api) 
* API: [https://github.com/quantixcoin/insight-api-quantix#instantsend-transactions](https://github.com/quantixcoin/insight-api-quantix#instantsend-transactions) 
...
By default, the Quantix Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Quantix Core daemon:
