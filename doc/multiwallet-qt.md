...
Only requiring some minor changes is quantix.cpp.
...
Changes to quantix.cpp
----------------------
quantix.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
