...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "QuantixNetwork") type = QuantixNetwork;
    if(strType == "QuantixNetworkVariable") type = QuantixNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == QuantixNetwork) s = "QuantixNetwork";
    if(type == QuantixNetworkVariable) s = "QuantixNetworkVariable";
