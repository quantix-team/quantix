 ...
 *
 *   // network
 *   CQuantixNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.quantix.site/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CQuantixNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CQuantixNetwork(UniValue objIn)
    {
...
// // can be under: QuantixNetwork
// //   -- signature requirements : Key1(User)
// class CQuantixNetworkVariable : public CGovernanceObject
// {
// private:
