    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Quantix Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Quantix address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and quantix: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Quantix Core"), this);
    aboutAction->setStatusTip(tr("Show information about Quantix Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Quantix Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Quantix addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Quantix addresses"));
    ...
    openAction->setStatusTip(tr("Open a quantix: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Quantix Core help message to get a list with possible Quantix Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Quantix Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Quantix network", "", count));
}
...
{
    QString strTitle = tr("Quantix Core"); // default title
