    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Quantix Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Quantix Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  quantix-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Quantix in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 QTX, 0.1 QTX, 1 QTX and 10 QTX -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://quantixcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://quantixcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Quantix Core is shutting down...") + "<br /><br />" +
