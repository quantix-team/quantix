    ...
    mapper(0)
{
    ...
    /* Theme selector */
    /*ui->theme->addItem(QString("QTX-light"), QVariant("light"));*/
    ui->theme->addItem(QString("QTX-blue"), QVariant("drkblue"));
    /*ui->theme->addItem(QString("QTX-Crownium"), QVariant("crownium"));*/
    ui->theme->addItem(QString("QTX-traditional"), QVariant("trad"));
