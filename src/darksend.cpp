...
{
    if(fLiteMode) return; // ignore all Quantix related functionality
...
/*
    ...
    allow endless transaction that would bloat Quantix and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("quantix-privatesend");
